...
export default function Personalrequest() {
    return (
        <main className="w-full flex flex-col items-center gap-1" >
            ...
            <Medicalform imagetext={"tolong lampirkan surat dari rt/rw"} excusetext={"apa alasanya"} warningtext={"apabila surat yang dilampirkan tidak memiliki stempel rt/rw maka surat akan ditolak"} />
        </main>)
}