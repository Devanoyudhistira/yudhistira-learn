...
export default function Attendancelist({ status, alasan, jaminan, tanggal }) {
        ...
        <li className="flex items-start w-full gap-3" >
            ...
            <div className="w-[90%]  flex flex-col px-3 py-2 rounded-3xl h-max bg-gray-100" >
                <div className="flex w-full justify-between items-center" >
                    ...
                    <h2 className="text-gray-600 font-medium text-md" > senin november 25 </h2>
                </div>
                <h1 className="text-xl mt-2 w-[80%] font-medium" > izin acara keluarga di surabaya </h1>
