...
export default function Assignmentlist({ tugas, namaguru, mapel, description,tanggal }) {
    return (<div className="w-[76%] h-60 flex flex-col gap-3  justify-start items-start px-4 py-2 shadow-md shadow-black/10 rounded-2xl" >
        <div className="w-full flex  justify-between items-center" >
            <div className="text-yellow-600 text-4xl bg-yellow-100 rounded-2xl p-3 flex items-center justify-center " > <Stopwatch />
            </div>
        ...
        <div className=" flex justify-start items-center h-15" >
            <h1 className="text-green-400 text-md font-bold uppercase" > In progress </h1>            
        </div>
    </div>
    )
}