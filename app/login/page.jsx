...
export default async function Page() {    
    return (
        <div className={"w-screen h-screen bg-sky-100/40 flex flex-col relative " + jakarta.className} >
            ...
            <form action="" className="w-[95%] h-max py-4  mt-8 self-center justify-self-center rounded-xl shadow-black shadow-md bg-gray-50 flex flex-col items-center " >
                ...
                <label className="flex flex-col w-max h-max" >
                    ...
                    <input type="password" className="border-2 focus:border-blue-500 border-gray-400 transition h-11 py-2 w-65 text-xl rounded-md px-1" name="email" id="email" />
                </label>
